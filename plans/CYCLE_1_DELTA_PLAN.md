...
- Dependencies and consumers: depends on FDN.005–FDN.010/FDN.012/FDN.015; RPT.005, IMM.016, CLI.006, FDN.006 terminal accounting, and FUZ.010 consume it.
...
- Dependencies and consumers: depends on BYT.001–BYT.006, REV.001–REV.009, DOC.001–DOC.015, SEC.001–SEC.009, RPT.002/RPT.003/RPT.007/RPT.010, and FDN.001–FDN.015 outputs for the represented strict or recovery-aware composition; RPT.004/RPT.005/RPT.009, IMM.004, and IMM.016 consume it.
...
- Dependencies and consumers: depends on FDN.002/FDN.008/FDN.015/FDN.017 and RPT.001–RPT.004/RPT.007; CLI, RPT.008, and IMM.004/IMM.016 consume it.
...
- Outputs and outcomes: canonical registry root, per-contract records with typed consequence axes and claim algebras, exact sorted prerequisite-edge and consumer indexes, exact shell §27 root/version plus tier/§27.1-falsifier/§27.4-release assignments, lifecycle/migration links, and validation findings.
- Diagnostics: duplicate ID, missing field/axis/card/falsifier/surface, missing or stale shell §27 root/version, omitted G7/G6.1 or applicable §27.1/§27.4 assignment, unauthorized local taxonomy replacement, inferred or unjustified not-applicable axis, missing/unknown claim algebra, unknown/bare/ambiguous dependency token, range expansion outside one family, illegal dependency, unknown outcome, lifecycle contradiction, and orphan contract.
...
- Falsifiers and Gauntlet: duplicate/missing fields or axes, omitted/stale shell §27/G6.1/G7/§27.1/§27.4 binding, local tier replacement, unjustified not-applicable value, unknown algebra/composition, dependency cycles, layer violation, prose/registry mismatch, surface widening, and migration cases.
...
- Falsifiers and Gauntlet: inject upward edge/cycle, inject a prerequisite cycle, merge a guarded recovered-mode transition into the prerequisite DAG, reverse or remove a transition phase/guard, admit a crate with fewer than two criteria, forge or reuse a boundary justification, remove or contradict a crate `CONTRACT.md`, add runtime dependency on tool/lab, hide a feature dependency, select an unratified crypto provider, seed an advisory, omit or stale the advisory snapshot, split an unreviewed duplicate version, forge an allowlist disposition, change a feature/target path, and omit metadata.
...
- Inputs and identity domain: exact strict/recovery/enrichment/validation/replay/capability-admission report roots including RPT.009 and RPT.010 when applicable, contract/claim/schema/card roots, FDN.010 availability records, checker protocol, every corroborating observation’s general `OracleLineageId`, checker-specific pre-run/final lineage roots, FDN.017 `HostOutputCapabilityId`, no-claims, disclosure policy, and canonical package protocol.
...
- Dependencies and consumers: depends on FDN.001–FDN.017, RPT.001–RPT.010, IMM.002–IMM.005, IMM.014, and IMM.020; IMM.013 independently consumes its raw output rather than producer objects, while CLI.009, IMM.019, and the close gate consume package/checker results.
